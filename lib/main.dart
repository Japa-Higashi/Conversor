...
class _HomeState extends State<Home> {
  ...
  void _dolarChanged(String text) {
    ...
    ieneControl.text = (dolar * this.dolar).toStringAsFixed(2);
  }
  ...
  void _euroChanged(String text) {
    ...
    ieneControl.text = (euro * this.euro).toStringAsFixed(2);
  }
  ...
  void _ieneChanged(String text) {
    ...
    // vamos pegar o dolar que o usuário digitou e mult pela cotação do jSON
    realControl.text = (iene * this.iene).toStringAsFixed(2);
    dolarControl.text = (iene * this.iene / dolar).toStringAsFixed(2);
    euroControl.text = (iene * this.iene / euro).toStringAsFixed(2);
  }
            ...
            switch (snapshot.connectionState) {
              ...
              default:
                if (snapshot.hasError) {
                  ...
                  iene = snapshot.data!["results"]["currencies"]["ARS"]["buy"];
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Divider(),
                        construiMeusCamposDeTexto(
                            "Iene", "JP\¥  ", ieneControl, _ieneChanged),
                      ],
                    ),
                  );
                }
...
Widget construiMeusCamposDeTexto(String label, String prefix,
  ...
  return TextField(
    ...
    decoration: InputDecoration(
      ...
      prefixText: prefix,
      prefixStyle: TextStyle(color: Colors.purple, fontSize: 25.0),
    ),
    style: TextStyle(color: Colors.purple, fontSize: 25.0),
